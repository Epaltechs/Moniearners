  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.mainArea}>
            <Image className={styles.loading} src="/load.png" alt="Loading..." width={64} height={64} /> 
            ...
            <div className={styles.formContainer}>
                <form>
                    <input type="text" name="email" value="" placeholder='1234  5678  9101  1121' className={styles.input} style={{marginBottom: 40}}/>
                    <div>
                        <button className={styles.button}>Pay #10,000</button>
                    </div>
